...
**v2.17.3** · [Changelog](CHANGELOG.md) · [![Docker Pulls](https://img.shields.io/docker/pulls/gatoserio/bpm-tagger)](https://hub.docker.com/r/gatoserio/bpm-tagger)
...
- **Listen mode** — the regular, non-cadence player (`/listen`): play the whole library or any playlist, in order or shuffled, at native speed — no BPM required — with a **radio** toggle that keeps the queue topped up from the same source. See [Listen](#listen-listen)
