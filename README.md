...
- **Queue** — live download progress, retry/cancel, delete failed items, and history
...
- **Queue** (`/queue`) — active downloads with live progress bars, retry/cancel, **Retry all failed**, per-row **Delete** on failed/skipped items, and completed history.
